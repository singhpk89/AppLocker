...
public class NumberLockView extends ViewGroup implements OnClickListener,
	...
	public NumberLockView(Context context, AttributeSet attrs) {
		super(context, attrs);
		TypedArray a = context.obtainStyledAttributes(attrs,
				R.styleable.NumberLockView);
		try {
			mHorizontalSpacing = a.getDimensionPixelSize(
					R.styleable.NumberLockView_horizontalSpacing, 0);
			mVerticalSpacing = a.getDimensionPixelSize(
					R.styleable.NumberLockView_verticalSpacing, 0);
			mRows = a.getInteger(R.styleable.NumberLockView_rows, mRows);
			mCols = a.getInteger(R.styleable.NumberLockView_cols, mCols);
			...
			mMaxWidth = a.getDimensionPixelSize(
					R.styleable.NumberLockView_maxWidth, 0);
			mMaxHeight = a.getDimensionPixelSize(
					R.styleable.NumberLockView_maxHeight, 0);
			mMaxHScale = a.getFloat(R.styleable.NumberLockView_maxHScale, 1F);
			mMaxVScale = a.getFloat(R.styleable.NumberLockView_maxVScale, 1F);

			mSquareChildren = a.getBoolean(
					R.styleable.NumberLockView_squareChildren, false);
	...
	/**
	 * Update the internal password this {@link NumberLockView} is working with.
